...
export const defaultContent = {
  hero: {
    ...
    cta: 'Try Cropsphere.ai',
    cta_link: '#',
  },
  about: {
    title: 'About Cropsphere.ai',
    body: 'Cropsphere.ai is our final year project: an AI-powered chatbot built to support the farming community of Sri Lanka. Farmers can ask questions about crop planning, cultivation methods, expected income, market prices, and seasonal decisions — and get clear, practical answers instantly.',
  },
  contact: {
...
export const defaultFeatures = [
  ...
  },
  {
    ...
    description:
      'Ask questions any time — Cropsphere.ai never sleeps, so help is always available when you need it.',
  },
  {
    icon: '🗣️',
...
export const defaultSteps = [
  ...
  },
  {
    ...
    description: 'Cropsphere.ai analyses your question using AI trained on agricultural knowledge.',
  },
  {
