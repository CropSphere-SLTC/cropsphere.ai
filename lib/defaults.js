...
// One collection, two views: the Our Team page splits these on `category`
// into the student grid and the Project Supervisors block.
export const defaultTeam = [
  ...
  },
  {
    ...
    role: 'Project Supervisor — SLTC',
    bio: 'Add your supervisors from the admin portal.',
    photo_url: '',
    category: 'supervisor',
  },
  {
    name: 'Co-Supervisor Name',
    role: 'Co-Supervisor — SLTC',
    bio: 'Add your supervisors from the admin portal.',
    photo_url: '',
    category: 'supervisor',
  },
